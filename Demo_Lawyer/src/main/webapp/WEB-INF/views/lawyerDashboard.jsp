...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="../resources/assets/img/sidebar-1.jpg">
      <!--
        Tip 1: You can change the color of the sidebar using: data-color="purple | azure | green | orange | danger"

        Tip 2: you can also add an image using data-image tag
    -->
      <div class="logo"><a href="http://www.uvega.in" class="simple-text logo-normal">
          Jeshtah Talent Solutions
        </a></div>
        
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item active  ">
            <a class="nav-link" href="./lawyerDashboard">
         ...
         <!--  <li class="nav-item ">
            <a class="nav-link" href="/clientCaseRegistration">
              <i class="material-icons">person</i>
              <p> client case registration </p>
            </a>
          </li> -->
            <li class="nav-item ">
            <a class="nav-link" href="./registerCase">
          ...
          <li class="nav-item ">
            ...
            <li class="nav-item ">
            <a class="nav-link" href="./ClientDetails">
               <i class="material-icons">person</i>
              <p>List Of Clients</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Lawyer's Dashboard <p> ${message}</p></a>
          </div>
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <!-- <a href="javascript:;">Get More Clients...</a> -->
                    
                    <button type="submit"> View Client List </button>
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <!--  Last 12 Months -->
                    <button type="submit"> View List of Cases </button>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">Total Court hearings</p>
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <!-- Tracked from Github -->
                    <button type="submit"> View List of Hearings </button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                   ...
                   <!--  Just Updated -->
                   <button type="submit"> View  List of Appointments </button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="https://www.creative-tim.com" target="_blank">Jeshtah Talent Solutions</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
